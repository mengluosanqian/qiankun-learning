pipeline {
    ...
    /*parameters {
        ...
        string(name:'APP_NAME',defaultValue: 'pkc-main-web',description:'docker image name')
        ...
        string(name:'HOST_PORT',defaultValue: '9001',description:'docker file path')
        string(name:'DOCKER_PORT',defaultValue: '9001',description:'docker file path')
